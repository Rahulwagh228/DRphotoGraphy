        ...
        <div className={styles.photographerCard}>
          ...
          <div className={styles.photographerContent}>
            ...
            <p>
              ...
              sessions. Known for his ability to capture raw emotions and create
              stunning compositions, Devendra's work has been featured in
        ...
        <div className={styles.photographerCard}>
          ...
          <div className={styles.photographerContent}>
            ...
            <p>
              ...
              Tushar's work is characterized by its vibrant energy and authentic
              storytelling approach. His modern techniques combined with
